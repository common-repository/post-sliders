...
<div class="wraper doc-suport">
	<div class="doc-support-header">
		<h1><?php _e( 'Post Slider', 'post-sliders' ); ?> </h1>
		<p><?php _e( 'Do you have any questions or need assistance? We\'re here to help!', 'post-sliders' ); ?> </p>
	</div>
	<div class="doc-support-content">
		<ul class="items-area">
			<li class="list-item">
				<h3><?php _e( 'Check Documentation', 'post-sliders' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://themepoints.com/postsliderpro/documentation/"><?php _e( 'Documentation', 'post-sliders' ); ?></a></div>
			</li>
			<li class="list-item">
				<h3><?php _e( 'Show Your Love', 'post-sliders' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://wordpress.org/support/plugin/post-sliders/reviews/"><?php _e( 'Rate Us Now', 'post-sliders' ); ?></a></div>
			</li>
			<li class="list-item">
				<h3><?php _e( 'Get Customer Support', 'post-sliders' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://www.themepoints.com/questions-answer/"><?php _e( 'Get Support', 'post-sliders' ); ?></a></div>
			</li>
			<li class="list-item">
				<h3><?php _e( 'Buy Us A Coffee', 'post-sliders' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://www.themepoints.com/shop/post-slider-pro/"><?php _e( 'Donate Now', 'post-sliders' ); ?></a></div>
			</li>
		</ul>
	</div>
</div>
